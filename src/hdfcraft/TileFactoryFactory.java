...
import hdfcraft.heightMaps.ConstantHeightMap;
import hdfcraft.heightMaps.DisplacementHeightMap;
import hdfcraft.heightMaps.MaximisingHeightMap;
import hdfcraft.heightMaps.NinePatchHeightMap;
import hdfcraft.heightMaps.NoiseHeightMap;
import hdfcraft.heightMaps.ProductHeightMap;
import hdfcraft.heightMaps.SumHeightMap;
...
//        continent = new NinePatchHeightMap(200, 100, 50, 58f);
        ...
        NoiseHeightMap a = new NoiseHeightMap(1.0f, 10f, 1);
        NoiseHeightMap b = new NoiseHeightMap(range, scale, 2);
