...
import hdfcraft.Dimension.Border;
import hdfcraft.TileRenderer.LightOrigin;

import hdfcraft.FrostExporter.FrostSettings;
import hdfcraft.ResourcesExporter.ResourcesExporterSettings;


import static hdfcraft.minecraft.Constants.DEFAULT_MAX_HEIGHT_2;
import static hdfcraft.minecraft.Material.DIRT;
import static hdfcraft.BiomeSchemeManager.*;
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        */
        ...
        if (defaultTerrainAndLayerSettings == null) {
            defaultTerrainAndLayerSettings = new Dimension(World2.DEFAULT_OCEAN_SEED,
                    TileFactoryFactory.createNoiseTileFactory(new Random().nextLong(), surface, defaultMaxHeight,
                            level, waterLevel, lava, beaches, 20, 1.0), Constants.DIM_NORMAL, defaultMaxHeight);
        }
        ...
        if (version < 3) {
            String maxRadiusStr = System.getProperty("hdfcraft.worldpainter.maxRadius");
        ...
        if (version < 5) {
            ...
            defaultTerrainAndLayerSettings.setLayerSettings(Resources.INSTANCE,
                    new ResourcesExporterSettings(defaultMaxHeight));
        }
        if (version < 6) {
        ...
        if (version < 9) {
            ...
            defaultGameType = hdfcraft.minecraft.Constants.GAME_TYPE_SURVIVAL;
        }
...
//    private boolean easyMode = true;
    ...
    private int defaultGameType = hdfcraft.minecraft.Constants.GAME_TYPE_SURVIVAL;
