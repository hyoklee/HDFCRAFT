...
import hdfcraft.minecraft.Direction;
 ...
 * @author pepijn
 */
public class World2 extends InstanceKeeper implements Serializable, java.lang.Cloneable {
    ...
    private int gameType = hdfcraft.minecraft.Constants.GAME_TYPE_SURVIVAL;
    @Deprecated
    ...
    public static final int DEFAULT_MAX_HEIGHT = hdfcraft.minecraft.Constants.DEFAULT_MAX_HEIGHT_2;
    // Old 1.6 values:
